...
//        loginBtn.isEnabled = false
    ...
    //        universityEmailTxtField.addTarget(self, action: #selector(LoginVC.textFieldDidChange), for: UIControlEvents.editingChanged)
    ...
    @IBAction func loginBtnPressed(_ sender: Any) {
        ...
        AuthService.signIn(email: (universityEmailTxtField?.text!)!, password: (passwordTxtField?.text!)!, onSuccess: {
            ...
            ProgressHUD.showError("OOPS! The username and password do not match")
        })
